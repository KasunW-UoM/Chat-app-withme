...
const LoginPage = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onClick={onSubmitHandler} className='bordor-2 bg-white/8 text-white border-gray-500 p-6 flex
      flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {!isDataSubmitted && (
          ...
          type="email" placeholder='Password'  required className='p-2 
          border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500'/>
          </>
        )}

        {
          currState === "Sign up" && isDataSubmitted && (
            ...
            focus:outline-none focus:ring-2 focus:ring-indigo-500' required placeholder='Provide a short bio...'>

            </textarea>
          )
        }
        <button type='Submit' className='py-3 bg-gradient-to-r from-purplr-400
